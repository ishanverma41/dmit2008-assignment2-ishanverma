...
export default async function SingleItem({ params }) {
    ...
    return (
        <>
            <PageHeader title={"Video Details"}></PageHeader>
            <div className="container">
                <div className="container-fluid">
                    <div className="card mx-1" >
                        <img src={videoData?.thumbnail} className="card-img-top" alt="thumbnail" height={300} />
                        <div className="card-body">
                            <h5 className="card-title text-center">{videoData?.title}</h5>
                            ...
                            <div className="text-center mt-2"><a href={`/products/${videoData?.video_id}`} className="btn btn-primary btn-lg">Buy Now</a></div>
                        </div>
                    </div>
                </div>
            </div>
